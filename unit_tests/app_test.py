...
class AppTestCase(unittest.TestCase):
    ...
    def test_search_get_no_filter(self, mock_requests_get, mock_get_unique_categories):
        ...
        fake_movies_data = {
            "movies": [
                {"listedIn": "Documentaries, International Movies", "title": "Movie1"},
        ...
        mock_get_unique_categories.return_value = [
            "Documentaries", "International Movies", "Action", "Adventure"
        ]
    ...
    @patch('app.get_unique_categories')
    @patch('app.requests.get')
    def test_search_post_with_filter(self, mock_requests_get, mock_get_unique_categories):
    ...
    def test_results(self, mock_requests_get, mock_get_unique_categories):
        ...
        query_string = (
            "title=Movie&type=Action&categories=Documentaries&categories=Action&release_year=2020"
        )
        ...
        mock_requests_get.assert_called_with(MOVIES_API_URL, params=expected_params)
